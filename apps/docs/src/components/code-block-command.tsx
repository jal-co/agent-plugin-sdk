 ...
 * and bundled SVG icons with optional overrides.
 *
 * Props:
 * - pnpm/yarn/npm/bun/shadcn?: command strings
 * - icons?: custom ReactNode icons keyed by manager (merged over defaults)
